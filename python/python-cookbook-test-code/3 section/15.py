...
Title;        字符串转换为日期
Issue: 你的应用程序接受字符串格式的输入，但是你想将它们转换为 datetime 对象以便
在上面执行非字符串操作。
Answer: 使用 Python 的标准模块 datetime 可以很容易的解决这个问题。
"""
