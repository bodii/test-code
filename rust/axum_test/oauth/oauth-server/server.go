...
func main() {
	...
	store.SetClient("000000", &osin.DefaultClient{
		Id:          "000000",
		Secret:      "999999",
		RedirectUri: "http://127.0.0.1:3000/auth/authorized",
	...
	http.HandleFunc("/info", func(w http.ResponseWriter, r *http.Request) {
		...
		resp.Output["id"] = "1234"
		resp.Output["avatar"] = "test_avatar.jpg"
		resp.Output["username"] = "test"
		resp.Output["discriminator"] = ""
		osin.OutputJSON(resp, w, r)
	})
