...
var Connection = function(options) {
  ...
  this.initialSocketTimeout = this.socketTimeout;
...
Object.defineProperty(Connection.prototype, 'socketTimeoutMS', {
  enumerable:true,
  set: function(value) {
    if(typeof value != 'number') throw new Error("socketTimeoutMS requires a number");
...
var errorHandler = function(self) {
  return function(err) {
    ...
    // Emit the error
    if(self.listeners('error').length > 0 || (self.ssl && self.state == 'CONNECTING')) self.emit("error", MongoError.create(err), self);
    // Set state to closed
...
Connection.prototype.connect = function(_options) {
  ...
  // Only change setting if a value is provided
  if(self.keepAlive) {
