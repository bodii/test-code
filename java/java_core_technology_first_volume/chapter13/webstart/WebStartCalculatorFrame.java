...
public class CalculatorFrame extends JFrame {
    ...
    public void setTitle() {
        try {
            ...
            PersistenceService service = (PersistenceService) ServiceManager.lookup(
            ...
            try {
                ...
                PrintStream out = contents.getOutputStream(true);
    ...
    public void open() {
        try {
            FileOpenService service = (FileOpenService) ServiceManager.lookup(
    ...
    public void save() {
        try {
            ...
            FileSaveService service = (FileSaveService) ServiceManager.lookup(
